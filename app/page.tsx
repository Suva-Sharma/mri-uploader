...
export default async function LandingPage() {
    ...
    <div className="min-h-screen bg-[#FDFDFD] text-slate-900">
        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-5 md:py-6">
          <div className="flex items-center gap-3">
            ...
            <div className="leading-tight">
              <div className="text-[30px] font-semibold tracking-tight text-[#004483]">MRI Report</div>
      ...
      <section className="relative overflow-hidden bg-gradient-to-r from-[#004483] via-[#0069CC] to-[#007AEB] text-white">
        ...
        <div className="relative mx-auto grid max-w-6xl gap-20 px-4 py-16 md:grid-cols-2 md:gap-20 lg:gap-28 md:py-20">
          ...
          {/* Image carousel block (single card, no outer unnecessary wrapper) */}
  ...
  <div className="w-full max-w-[680px] md:max-w-[760px] lg:max-w-[860px] xl:max-w-[920px]">
    <LaptopScreenCarousel
      ...
      className="scale-[2.15] md:scale-[2.5] origin-center md:origin-right md:translate-x-16 lg:translate-x-68"
  ...
  <div className="mx-auto max-w-6xl px-4">
    ...
    <div className="grid gap-6 md:grid-cols-2">
      {plans.map((p) => (
       <article
       key={p.key}
       className="relative overflow-hidden rounded-2xl bg-[#FDFDFD] p-6 md:p-7 h-full flex flex-col shadow-[0_16px_40px_rgba(0,68,131,0.14)] transition duration-300 hover:-translate-y-0.5 hover:shadow-[0_20px_48px_rgba(0,68,131,0.18)]"
     >
          {/* top accent line */}
          <div
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {p.outputs.map((item) => (
                <li key={item} className="flex items-start gap-2.5 text-sm text-[#0F3F75] md:text-[15px]">
        ...
        <div className="mx-auto max-w-6xl px-4">
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-3">
            {securityCards.map((c) => (
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="grid h-12 w-12 place-items-center rounded-xl bg-[#EAF4FF] text-2xl">{c.icon}</div>
